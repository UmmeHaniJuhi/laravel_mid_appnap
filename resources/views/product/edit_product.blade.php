    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="div_center">
                <h2 class="h2_font">Edit/Update Product</h2>
                <div>
                    ...
                    <div class="div_design">
                        ...
                        <select class="text_color" name="catagory_id" id="" required="">
                            <option value="{{$product->catagory->id}}" selected="">{{$product->catagory->ctagory_name}}</option>
                    ...
                    <div class="div_design">
                        ...
                        <img src="/products/{{$product->image}}" alt="" height="100" width="100">
                    </div>
                    <div class="div_design">
